...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $profession = DB :: table( 'professions' ) -> select( 'id' ) -> take( 1 ) -> get();    # Obtiene un objeto con un solo Array obteniendo de este sus valores
        ...
        DB :: table( 'users' ) -> insert([
            ...
            'profession_id' => $profession -> first() -> id   # Insertamos un ID existente en la tabla 'professions'
        ]);
    }
}
