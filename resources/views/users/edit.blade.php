...
@section( 'content' )        {{-- Define la sección 'content' --}}
    ...
    <div class="card">
        <h4 class="card-header">Edita usuario</h4>
        <div class="card-body">
            ...
            <form action="{{ url( "usuarios/{$user->id}" ) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input id="name" class="form-control" type="text" name="name" placeholder="Ej: Juliana Puerta" value="{{ old( 'name', $user -> name ) }}">
                    @if( $errors -> has( 'name' ) )
                ...
                <div class="form-group">
                    ...
                    <input id="email" class="form-control" type="email" name="email" placeholder="Ej: julipuerta@correo.co" value="{{ old( 'email', $user -> email ) }}">
                    @if( $errors -> has( 'email' ) )
